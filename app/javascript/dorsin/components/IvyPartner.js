                ...
                <div className="row vertical-content">
                    <div className="col-lg-12">
                        <div className="features-box">
                            ...
                            <h3>Why partner with IvyNet, providers of IvyLocker?</h3>
                        ...
                        <a href="/solutions" className="btn btn-custom margin-t-30 waves-effect waves-light">Read about services <i className="mdi mdi-arrow-right"></i></a>
